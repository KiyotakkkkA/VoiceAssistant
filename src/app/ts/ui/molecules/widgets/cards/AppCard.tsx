...
const AppCard: React.FC<{ app: App }> = ({ app }) => {
    return (
        <div key={app.id} className='group p-3 bg-ui-bg-secondary border border-ui-border-primary/70 rounded-lg hover:border-ui-text-accent/30 hover:bg-ui-background-secondary/20 transition-all cursor-pointer'>
