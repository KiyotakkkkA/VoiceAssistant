                ...
                <div>
                    {isEnabled ? (
                        <div className="flex justify-between mt-2 gap-4">
                            <button className="w-full bg-red-500/10 text-red-400 border border-red-500/20 px-3 py-1 rounded-md text-sm hover:bg-red-500/20 transition-colors">
                                Выключить
                            </button>
                            <button className="w-full bg-blue-500/10 text-blue-400 border border-blue-500/20 px-3 py-1 rounded-md text-sm hover:bg-blue-500/20 transition-colors">
                                Перезапустить
                            </button>
                        </div>
                    ) : (
                        <div className="flex justify-between mt-2 gap-4">
                            <button className="w-full bg-green-500/10 text-green-400 border border-green-500/20 px-3 py-1 rounded-md text-sm hover:bg-green-500/20 transition-colors">
                                Включить
                            </button>
                        </div>
                    )}
