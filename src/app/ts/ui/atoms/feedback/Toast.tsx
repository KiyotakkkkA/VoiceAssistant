...
const Toast: React.FC<Props> = ({ title, className }) => {
  return (
    <div className={`pointer-events-auto select-none group relative px-4 py-3 rounded-md border border-ui-border-primary bg-ui-bg-secondary-light shadow-lg overflow-hidden animate-slide-in ${className}`}>
